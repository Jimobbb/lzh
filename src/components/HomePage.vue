  ...
  <div>
    ...
    <div :class="'homepage ' + (loading ? 'loading' : '')">
      ...
      <div class="pass-content" v-if="hiddenLoading">
        ...
        <md-list class="pass-list">
          <md-list-item>
            ...
            <div class="md-list-action list-text">{{ name }}</div>
          </md-list-item>
          <md-list-item>
          ...
          <md-list-item>
            ...
            <div class="md-list-action list-text time-text">
              <div class="line-text">{{ timeStr }} {{ timeStr }} {{ timeStr }} {{ timeStr }} {{ timeStr }} {{ timeStr }} {{ timeStr }} {{ timeStr }}</div>
            </div>
          </md-list-item>
        </md-list>
      </div>
      ...
      <div class="logo" v-if="hiddenLoading">
        <img src="../assets/logo.png" alt="" class="logo-img"  @click="clickName">
      </div>
